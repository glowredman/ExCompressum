...
public class ExCompressum {
    ...
    public static String autoSieveSkinsURL;
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        autoSieveSkinsURL = config.getString("autoSieveSkinsURL", "general", "https://whitelist.blay09.net/api/whitelists/BlayTheNinth", "");
